...
// console.log(john[x]joo)

john = Object.assign(john,moreProperties )
...
for(let key in  john )
    ...
    let names = ["John","James","Sally","Charity","Joseph"]

//values and index-index you can get values(to iterate through arrays)
...
const items = ["Ayush","Swapna","Ravi","Ayash","Sajal"]
// items.push("Ashish")
// items.unshift("Jethro")
// items.pop(4)
// items.shift(0)
items.splice(0,2,"Paul","Patience","Anne")
// items.fill("Anthony")
// let sliced =items.splice(0,3)

// console.log(sliced)

// const name1 = ["Nelly","Samuel","Jethro","Rodgers"]
// const name2 = ["David","Janet","Rahab", "Justin"]

// const nme = name1.concat(name2)
// nme.reverse()
// console.log(nme)
// nme.sort()
// console.log(nme)
...
users.sort(function (x,y)
{
    ...
    return x.address.geo.localeCompare(y.address.geo)
